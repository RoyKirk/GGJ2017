...
////// Emissive:
                ...
                float node_6992 = (node_7045.g*6.28318530718*_Speed);
                float4 _Noise_var = tex2D(_Noise,TRANSFORM_TEX(i.uv0, _Noise));
                float node_536 = saturate(((((1.0 - node_6992)*1.6+-0.8)+_Noise_var.r)*8.0+-4.0));
