...
////// Emissive:
                ...
                float node_7078 = (sin(node_1299.a)*1.5+1.5);
                float node_7690 = (pow((abs((frac(node_6072.g)-0.5))*2.0),node_7078)*pow((abs((frac(node_6072.r)-0.5))*2.0),node_7078));
                float3 emissive = (_GlowColor.rgb*node_7690*(_GlowColor.rgb+node_7690));
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float node_7078 = (sin(node_1299.a)*1.5+1.5);
                float node_7690 = (pow((abs((frac(node_6072.g)-0.5))*2.0),node_7078)*pow((abs((frac(node_6072.r)-0.5))*2.0),node_7078));
                o.Emission = (_GlowColor.rgb*node_7690*(_GlowColor.rgb+node_7690));
